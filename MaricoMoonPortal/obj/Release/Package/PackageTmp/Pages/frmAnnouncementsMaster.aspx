<%@ Page Title="" Language="C#" MasterPageFile="~/MySpace.Master" AutoEventWireup="true" CodeBehind="frmAnnouncementsMaster.aspx.cs" Inherits="MySpace.Pages.frmAnnouncementsMaster" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <asp:TextBox ID="txtheading" runat="server" class="form-control" required="required" Width="100%"></asp:TextBox>
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <div class="input-group-btn">
                                                <asp:Button ID="btnaddnew" runat="server" Text="Add New Announcement" class="btn btn-primary" OnClick="btnaddnew_Click" />
                                            </div>
                        ...
                        <asp:Panel ID="pnlgrid" runat="server" Visible="true">
                            <div class="box">
                                ...
                                <div class="box-body table-responsive no-padding">
                                    <asp:GridView ID="gvAnnounceMaster" runat="server" AutoGenerateColumns="False" class="table table-bordered"
                                        OnRowDataBound="gvAnnounceMaster_RowDataBound" OnRowUpdating="gvAnnounceMaster_RowUpdating" OnRowCommand="gvAnnounceMaster_RowCommand"
                                        OnRowEditing="gvAnnounceMaster_RowEditing" OnRowCancelingEdit="gvAnnounceMaster_RowCancelingEdit" OnPageIndexChanging="gvAnnounceMaster_PageIndexChanging"
